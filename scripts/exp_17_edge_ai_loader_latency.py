...
def main() -> None:
    parser = argparse.ArgumentParser(description="Experiment 6.3: edge-AI loader P95 latency.")
    ...
    context = build_context(args.var, workload="edge_ai_loader")
    materialize_input_file(
    ...
    results = [
        TrialResult("exp_17_edge_ai_loader_latency", index + 1, True, "latency", value, "ms", "edge_ai_loader")
        for index, value in enumerate(latencies)
    ]
    finalize_results("exp_17_edge_ai_loader_latency", results, args.output_dir)
